class RequestsController < ApplicationController
  ...
  # POST /requests.json
  def create
    @request = Request.new(:request_ip => (request.remote_ip.to_s), :content => request.body.read(), :content_length => request.content_length, :request_type => (request.method.to_s))
    if @request.save
